...
def _MakePlots(rev_week_values, slopes, fitter,
...
def _UpdateProto(fitter, result):
...
def Run(filename, num_weeks, output_path):
    ...
    # Update results.
    (poly_quadratic, poly_cubic, poly_linear) = _UpdateProto(fitter, result)

    # Prepare plots.
    _MakePlots(rev_week_values, slopes, fitter,
               poly_quadratic, poly_cubic, poly_linear)
